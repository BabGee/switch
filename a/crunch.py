...
from primary.core.administration.models import AccessLevel, Gateway, Channel
from primary.core.upc.models import Institution
from primary.core.bridge.models import Service,ServiceStatus
from secondary.channels.iic.models import Page, \
    ServiceCommand, \
    PageInputGroup, \
    PageInput, \
    PageGroup, \
...
def process_services(config):
    for service_config in config:
        ...
        try:
            ...
            service.status = ServiceStatus.objects.get(name='ENABLED')
            service.save()
