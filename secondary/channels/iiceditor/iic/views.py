...
def page_group_list(request, gateway_pk, service_name):
    ...
    return render(request, "iiceditor/page_group/list.html", {
        'gateway': gateway,
...
def page_list(request, gateway_pk, service_name, page_group_pk):
    ...
    return render(request, "iiceditor/page/list.html", {
...
def page_order(request, gateway_pk, service_name, page_group_pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect(
                '/admin/iiceditor/iiceditor/{}/{}/page_groups/{}/pages/order/'.format(gateway_pk, service_name, page_group_pk)
            )
    else:
        form = PageOrderConfigForm()

    return render(request, "iiceditor/page/order.html", {
        'gateway': gateway,
        'service': service_name,
        'pages': pages,
        'form': form,
...
def page_role_right_create(request, gateway_pk, service_name, page_group_pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect(
                '/admin/iiceditor/iiceditor/{}/{}/page_groups/{}/pages/'.format(
    ...
    return render(request, "iiceditor/page/create_role_right.html", {
        'gateway': gateway,
        'service': service_name,
        'form': form,
        'page_group': page_group,
...
def page_create(request, gateway_pk, service_name, page_group_pk):
    ...
    return render(request, "iiceditor/page/create.html", {
        'gateway': gateway,
        'service': service_name,
...
def page_detail(request, gateway_pk, service_name, page_group_pk, page_pk):
    ...
    return render(request, "iiceditor/page/detail.html", {
        'gateway': gateway,
        'page': page,
        'service': service_name,
        'page_group': page_group})
...
def page_group_create(request, gateway_pk, service_name):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            # http://localhost:8000/iic_editor/gateways/4/page_groups/30/pages/order/
            return redirect(
                '/admin/iiceditor/iiceditor/{}/{}/page_groups/'.format(gateway_pk, service_name)
            )
    else:
    ...
    return render(request, "iiceditor/page_group/create.html", {
        'gateway': gateway,
        'service': service_name,
        # 'page_groups': page_groups,
        'form': form,
...
def page_input_group_list(request, gateway_pk, service_name, page_group_pk, page_pk):
    ...
    return render(request, "iiceditor/page_input_group/list.html", {
        'gateway': gateway,
        'page': page,
        'service': service_name,
...
def page_input_group_detail(request, gateway_pk, service_name, page_group_pk, page_pk, page_input_group_pk):
    ...
    return render(request, "iiceditor/page_input_group/detail.html", {
        'gateway': gateway,
        'page': page,
        'service': service_name,
...
def page_input_group_create(request, gateway_pk, service_name, page_group_pk, page_pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return redirect(
                '/admin/iiceditor/iiceditor/{}/{}/page_groups/{}/pages/{}/page_input_groups/{}/'.format(
                    gateway_pk, service_name, page_group_pk, page_pk, page_input_group.pk
                )
            )
    else:
        form = PageInputGroupForm()
    return render(request, "iiceditor/page_input_group/create.html", {
        'gateway': gateway,
        'service': service_name,
        'page_group': page_group,
        'page': page,
...
def page_input_create(request, gateway_pk, service_name, page_group_pk, page_pk, page_input_group_pk):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            page_input.channel.add(*Channel.objects.filter(name__in=default_channels))
            return redirect(
                '/admin/iiceditor/iiceditor/{}/{}/page_groups/{}/pages/{}/page_input_groups/{}/page_inputs/'.format(
    ...
    return render(request, "iiceditor/page_input/create{}.html".format(request.GET.get('editor','')), {
        'gateway': gateway,
        'page': page,
...
def page_input_order(request, gateway_pk, service_name, page_group_pk, page_pk, page_input_group_pk):
    ...
    return render(request, "iiceditor/page_input/order.html", {
        'gateway': gateway,
        'service': service_name,
        'page': page,
        'form': form,
...
def page_input_list(request, gateway_pk, service_name, page_group_pk, page_pk, page_input_group_pk):
    ...
    return render(request, "iiceditor/page_input/list.html", {
...
def page_input_detail(request, gateway_pk, service_name, page_group_pk, page_pk, page_input_group_pk, page_input_pk):
    ...
    if request.method == "POST":
        ...
        return render(request, "iiceditor/page_input/detail.html", {
            'gateway': gateway,
            'page': page,
...
def page_input_copy(request, gateway_pk, service_name, page_group_pk, page_pk, page_input_group_pk, page_input_pk):
    ...
    return render(request, "iiceditor/page_input/create.html", {
        'gateway': gateway,
        'page': page,
        'form': form,
        'page_input': page_input,
...
def input_variable_detail(request, input_variable_pk):
    ...
    return render(request, "iiceditor/service_command/list.html", {
...
def page_group_detail(request, gateway_pk, service_name, page_group_pk):
    ...
    return render(request, "iiceditor/page_group/detail.html", {
        'gateway': gateway,
        'service': service_name,
        'page_group': page_group})
...
def interface(request, gateway_pk, service_name, page_group_pk=None, page_pk=None, page_input_group_pk=None):
    ...
    return render(request, "iiceditor/page_group/interface.html", {
        'trigger_list': json.dumps(list(Trigger.objects.all().order_by('-id').values_list('name', flat=True))),
        'all_access_levels': AccessLevel.objects.all(),
