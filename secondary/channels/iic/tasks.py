...
class System(Generator):
	...
	def redirect(self, payload, node_info):
		...
		try:
			...
			elif 'redirect' not in payload.keys() and payload['SERVICE'] in ['LOGIN','CONFIRM ONE TIME PASSWORD','SET PASSWORD','CONFIRM ONE TIME PIN', 'SOCIAL REGISTRATION LOGIN', 'LOGIN SOCIAL']:
