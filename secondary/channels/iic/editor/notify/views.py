...
def service_notification(request, gateway_pk, service_name):
    ...
    return render(request, 'editor/notify/notification/list.html', {
...
def notification_templates(request, service_pk):
    ...
    return render(request, 'editor/notify/notification_template/partials/notification_templates.html', {
...
def outbound_list(request):
    ...
    return render(request, 'editor/notify/outbound/list.html', {
        'outbounds': outbounds
    })
...
def outbound_list_updates(request):
    ...
    if outbound:
        return render(request, 'editor/notify/outbound/item.html', {
            'outbound': outbound
        })
