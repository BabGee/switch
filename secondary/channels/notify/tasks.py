...
def get_delivery_status():
	try:
		df = pd.DataFrame(WebService().post_request({"module":"sdp", "function":"getSmsDeliveryStatusResponse",  "limit":10000, "min_duration": {"seconds": 60}, "max_duration": {"seconds": 45}}, 'http://192.168.137.28:732/data/request/')['response']['data'])
		if len(df):
