...
async def notify_notifications():
	...
	while 1:
		try:
			...
			notification = app.loop.run_in_executor(thread_pool, _send_outbound_messages, *[False, 110])
			tasks.append(notification)
			#Bulk Notification
			bulk_notification = app.loop.run_in_executor(thread_pool, _send_outbound_messages, *[True, 390])
