...
class Menu(models.Model):
	...
	page_string_response = models.CharField(max_length=2048, blank=True, null=True, help_text='response_status%page_string%state|') 
...
class MenuItem(models.Model):
	...
	response_status = models.ForeignKey(ResponseStatus, null=True, blank=True)
	enrollment_type_included = models.ManyToManyField(EnrollmentType, blank=True)
