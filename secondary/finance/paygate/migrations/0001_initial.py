    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.BooleanField(default=False)),
                ('float_amount', models.DecimalField(decimal_places=2, max_digits=19)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=45, unique=True)),
                ('description', models.CharField(max_length=100)),
                ('float_product_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='float_product_type', to='crm.ProductType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='administration.Currency')),
                ('institution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='upc.Institution')),
                ('institution_notification', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='paygate.InstitutionNotification')),
            ],
        ),
        migrations.CreateModel(
            name='OutgoingState',
        ...
        migrations.AddField(
            model_name='incoming',
            name='institution_incoming_service',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='paygate.InstitutionIncomingService'),
        ),
        migrations.AddField(
            model_name='incoming',
            name='remittance_product',
