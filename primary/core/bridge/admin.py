...
class ServiceCommandAdmin(admin.ModelAdmin):
		...
		list_filter = ('service','node_system','gateway','access_level','channel','payment_method','status',)
...
class PollAdmin(admin.ModelAdmin):
	list_display = ('id','name','description','request','service','frequency','last_run','status','gateway_profile',)
